...
solar_energy_per_panel = calculate_solar_energy(panel_area, panel_efficiency, solar_annual, estimate_sunlight_hours(lat))
wind_energy_per_turbine = calculate_wind_energy(air_density, turbine_area, windata_annual, turbine_efficiency, wind_hours_per_year)
...
def calculate_panels_and_turbines(required_energy, solar_energy_per_panel, wind_energy_per_turbine, solar_fraction=0.5):
    ...
    if num_solar_panels > 10000:
            print(wind_energy_per_turbine)
            print(wind_energy_required)
